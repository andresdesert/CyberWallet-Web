                ...
                <Box
                    sx={{
                        ...
                        background: (theme) => theme.palette.mode === 'dark'
                            ...
                            : 'linear-gradient(135deg, rgba(99, 179, 237, 0.08), rgba(168, 85, 247, 0.05), rgba(255, 255, 255, 0.95))',
                        borderRadius: 4,
                        p: { xs: 4, sm: 5 },
                        // 💎 Borde más prominente para definición clara
                        border: (theme) => theme.palette.mode === 'dark'
                            ? '2px solid rgba(76, 145, 240, 0.3)'
                            : '2px solid rgba(99, 179, 237, 0.3)',
                        ...
                        boxShadow: (theme) => theme.palette.mode === 'dark'
                            ...
                            `
                            : `
                                0 12px 30px rgba(99, 179, 237, 0.15),
                        ...
                        <Chip
                            ...
                            sx={{
                                ...
                                border: (theme) => theme.palette.mode === 'dark'
                                    ...
                                    : '2.5px solid rgba(99, 179, 237, 0.5)',
                                // ✨ Sombras multicapa para máxima profundidad
                                boxShadow: (theme) => theme.palette.mode === 'dark'
                                    ? `
                                    ...
                                    `
                                    : `
                                        0 4px 15px rgba(99, 179, 237, 0.18),
                                ...
                                '&:hover': {
                                    ...
                                    border: (theme) => theme.palette.mode === 'dark'
                                        ...
                                        : '2.5px solid rgba(99, 179, 237, 0.8)',
                                    ...
                                    boxShadow: (theme) => theme.palette.mode === 'dark'
                                        ...
                                        `
                                        : `
                                            0 8px 25px rgba(99, 179, 237, 0.25),
